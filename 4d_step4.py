...
def get_terms(polynomial_as_string):
    R2 = macaulay2('QQ['+','.join(['a'+str(i)+str(j) for i in range(1,6) for j in range(1,6) if not i==j])+', t'+']')
...
a12, a13, a14, a15, a21, a23, a24, a25, a31, a32, a34, a35, a41, a42, a43, a45, a51, a52, a53, a54, t = R.gens()
