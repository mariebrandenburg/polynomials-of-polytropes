...
with open("../../output/3d/3d_ehr_pols.txt","r") as input_file_multi_ehr:
...
with open("3d_erhart_test_data","r") as input_file_ehrhart_test:
...
for index in range(len(multi_ehr)):
    ...
    if index == 0:
        ...
        mode = "a"
    with open("3d_output_comparison_ehr.txt", mode) as output_file:
